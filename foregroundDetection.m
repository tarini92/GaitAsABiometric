...
videoSource = vision.VideoFileReader('C:\Users\Akanksha\Desktop\Project\Dataset\videos\test44.MOV','ImageColorSpace','Intensity','VideoOutputDataType','uint8');
...
while ~isDone(videoSource)
     ...
     out = getframe(fm);
     filename = strcat('C:\Users\Akanksha\Documents\MATLAB\test44BBox\output_test44_',num2str(i),'.png');
